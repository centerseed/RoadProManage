...
public class ParkSearchResultAdapter extends AbstractRecyclerCursorAdapter {
    ...
    public ParkSearchResultAdapter(Context context, Cursor c) {
        super(context, c);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, Cursor cursor) {
        ...
        holder.tvName.setText(cursor.getString(cursor.getColumnIndex(RoadProProvider.FIELD_CAR_STATION_NAME)));
        holder.tvAddress.setText(cursor.getString(cursor.getColumnIndex(RoadProProvider.FIELD_CAR_STATION_ADDRESS)));
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (mListener != null) {
                        ...
                        mListener.onResultClick(cursor.getString(cursor.getColumnIndex(RoadProProvider.FIELD_CAR_STATION_ADDRESS)));
                    }
                }
            });
        }
